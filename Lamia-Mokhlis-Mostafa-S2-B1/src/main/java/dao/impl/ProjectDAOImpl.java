...
/**
 * Implementation of the ProjectDAO interface for managing Project entities in the database.
 */
public class ProjectDAOImpl implements ProjectDAO {
	...
	/**
	 * Constructs a new ProjectDAOImpl and initializes the database connection.
	 */
	...
	/**
	 * Finds a project in the database by its ID.
	 *
